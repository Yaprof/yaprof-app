<template>
    <div>
        ...
        <div id="popup_creator_parent" class="fixed top-0 left-0 flex items-center h-screen w-full overflow-hidden z-[-1] transition-all !z-[99] opacity-0 pointer-events-none">
            <div id="popup_creator" class="flex flex-col items-center bg-light dark:bg-secondary rounded-t-xl shadow-xl h-full w-full mt-32 drop-shadow-lg translate-y-full py-10 px-5 gap-5 z-[998] transform-gpu">
