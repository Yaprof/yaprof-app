<template>
    <div :id="'container_info_'+data.id" class="flex flex-col gap-3 relative">
        ...
        <div v-if="data.author.id == user.id || [20, 50, 99].includes(user?.role)" :id="'popup_info_'+data.id" class="bg-light dark:bg-secondary p-5 pb-14 fixed bottom-0 left-0 w-full rounded-xl flex flex-col translate-y-full text-dark dark:text-white transition-all" v-click-outside="closePopupInfos">
