export default defineNuxtConfig({
        ...
        head: {
            ...
            meta: [
                ...
                },
                {
                    ...
                    name: "description",
                    content:
                        "Yaprof est une application mobile utilisant Pronote dans le but de servir d'outil aux élèves et leur indiquer si un professeur est présent ou non.",
                },
                { name: "robots", content: "all" },
                {
                    name: "keywords",
                    content:
                        "yaprof, app, pronote, pronoteapi, scolaire, lycée, collège, notes, profs application",
                },
                ...
                { name: "msapplication-TileColor", content: "#12d4a6" },
                {
                    ...
                    content: "/icons/icon_512x512.png",
                },
    ...
    runtimeConfig: {
        public: {
            ...
            PRONOTE_API_URL: "http://api.getpapillon.xyz/", //'https://pronoteapi.yaprof.fr', // 'http://localhost:8000',
