            ...
            <div id="form_login" v-if="!qrValid" class="flex flex-col items-center gap-3 pt-8 px-5 w-full">
                <div v-click-outside="closeEntSarch" class="flex flex-col gap-1 w-full relative">
                    ...
                    <div v-show="ent_content" class="absolute top-[calc(100%)] left-0 rounded-b-xl bg-white dark:bg-secondary shadow-md px-2 flex flex-col w-full z-50 py-3">
                        ...
                        <div v-else-if="loadingEtabs" class="py-3.5 px-6 flex items-center gap-3">
                            <p class="text-lg text-dark dark:text-white font-medium whitespace-nowrap truncate">Chargement en cours...</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center gap-3 w-full mt-2">
                    <div @click="connect($event.target)" class="w-full rounded-xl bg-primary py-3.5 px-5 text-dark font-medium text-lg text-center flex items-center justify-center active:bg-opacity-90 transition-all">Se connecter</div>
                    <div id="loading-button" class="w-full rounded-xl bg-primaryhover brightness-90 py-3.5 px-5 text-dark font-medium text-lg text-center flex items-center justify-center hidden">Chargement...</div>
                </div>
            </div>
