    ...
    <NuxtLayout>
        <div>
            <div class="flex items-center gap-3 pb-5 ">
                <button @click="this.$router.go(-1)" class="active:scale-95 transition-all cursor-pointer">
            ...
            <div class="flex flex-col gap-2">
                <div class="w-full shadow-md relative rounded-xl overflow-hidden">
                    <img class="w-full object-cover object-center absolute top-0 left-0 h-full blur-lg scale-150 brightness-110 dark:brightness-90" :src="user.profile?.pp" />
